...
import { SHOP_LIST_REQUEST, SHOP_LIST_SUCCESS, SHOP_LIST_FAIL,
         ...
         SHOP_UPDATE_REQUEST, SHOP_UPDATE_SUCCESS, SHOP_UPDATE_FAIL,
         SHOP_DELETE_REQUEST, SHOP_DELETE_SUCCESS, SHOP_DELETE_FAIL
    } from '../actions/types';



export function shopListReducer (state = {shops: []}, action) {
    switch (action.type) {
...
export function shopDetailsReducer(state = { shop: {} }, action) {
    switch (action.type) {
...
export function shopDeleteReducer(state = { shop: {} }, action) {
    switch (action.type) {
...
export function shopSaveReducer(state = { shop: {} }, action) {
    switch (action.type) {
